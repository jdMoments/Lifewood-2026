...
const ScrollStack = ({
  ...
  useLayoutEffect(() => {
    ...
    cards.forEach((card, i) => {
      ...
      card.style.transition = `transform ${scaleDuration}s cubic-bezier(0.22, 1, 0.36, 1), filter ${Math.max(
        0.15,
        scaleDuration * 0.8
      )}s ease`;
    });
    ...
    return () => {
      ...
      target.removeEventListener('scroll', requestUpdate as EventListener);
